...
public class MainScreenAssets {
	...
	private void loadButtons() {
		...
		buttonHighscore = new TextButton(myBundle.get("highscore"), skin);
	...
	private void setTable() {
		...
		table.add(buttonPlay).size(Config.BWIDTH, Config.BHEIGHT).center().row();;
		table.add(buttonOption).size(Config.BWIDTH, Config.BHEIGHT).center().row();
		table.add(buttonHighscore).size(Config.BWIDTH, Config.BHEIGHT).center().row();;
		table.add(buttonTutorial).size(Config.BWIDTH, Config.BHEIGHT).center().row();;
		table.add(buttonQuit).size(Config.BWIDTH, Config.BHEIGHT).center().row();;
	}
