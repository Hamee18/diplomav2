...
public class AndroidGameScreenAssets implements InputProcessor {
	...
	private TextButton left, right, up, down, rotate, rAndM;
	...
	private boolean rotateObj = false;
	...
	public AndroidGameScreenAssets(Root root, AndroidGameScreen androidScreen) {
		this.root = root;
		this.gameScreen = androidScreen;
	...
	private void loadKeyboardComponents() {
		...
		turnLeft.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.A);
			}
		});
		...
		turnLeftZ.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.Q);
			}
		});
		...
		turnDown.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.S);
			}
		});
		...
		turnUp.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.W);
			}
		});
		...
		turnRight.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.D);
			}
		});
		...
		turnRightZ.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.E);
			}
		});
		...
		left.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.LEFT);
			}
		});
		...
		right.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.RIGHT);
			}
		});
		...
		down.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.DOWN);
			}
		});
		...
		up.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.UP);
			}
		});
	...
	private void loadComponent() {
		...
		rotate.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				AndroidGameScreenAssets.this.keyUp(Keys.CONTROL_LEFT);
			}
		});
		
		TextButtonStyle style2 = new TextButtonStyle();
		style2.font = imageButtonSkin.getFont("black");
		style2.up = imageButtonSkin.getDrawable("rotate");
		style2.down = imageButtonSkin.getDrawable("moveClick");
		rAndM = new TextButton("", style2);
		rAndM.setPosition(Config.WIDTH - rAndM.getWidth() - 130, 100);
		rAndM.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				TextButtonStyle style = new TextButtonStyle();
				
				if (rAndM.getStyle().up == imageButtonSkin.getDrawable("rotate")) {
					style.up =  imageButtonSkin.getDrawable("moveClick");
					style.down =  imageButtonSkin.getDrawable("rotate");
					rotateObj = false;
				} else {
					style.up = imageButtonSkin.getDrawable("rotate");
					style.down = imageButtonSkin.getDrawable("moveClick");
					rotateObj = true;
				}
				style.font = imageButtonSkin.getFont("black");
				
				rAndM.setStyle(style);
			}
		});
	...
	private void loadSounds() {
		...
		rotateSound = Gdx.audio
				.newSound(Gdx.files.internal("music/rotate.wav"));
