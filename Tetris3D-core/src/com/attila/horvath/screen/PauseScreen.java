...
public class PauseScreen implements Screen {
	...
	public PauseScreen(Root root, WindowsGameScreen gameScreen) {
		...
		assets = new PauseScreenAssets(this.root, this.gameScreenWindows, this);
		
		stateTime = 0F;
	}
	
	public PauseScreen(Root root, AndroidGameScreen gameScreen) {
		this.root = root;
		this.gameScreenAndroid = gameScreen;
		
		batch = new SpriteBatch();
		assets = new PauseScreenAssets(this.root, this.gameScreenAndroid, this);
