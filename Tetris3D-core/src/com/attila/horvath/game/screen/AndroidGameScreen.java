...
import com.attila.horvath.assets.AndroidGameScreenAssets;
...
public class AndroidGameScreen implements Screen{
	...
	private AndroidGameScreenAssets assets;
	...
	@Override
	public void show() {
		assets = new AndroidGameScreenAssets(this.root, this);
